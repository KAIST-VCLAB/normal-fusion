...
double TimingLog::totalTimeICP = 0.0;
unsigned int TimingLog::countTimeICP = 0;

double TimingLog::totalTimeEnhanceInput = 0.0;
unsigned int TimingLog::countTimeEnhanceInput = 0;

double TimingLog::totalTimeIntegrateDepth = 0.0;
unsigned int TimingLog::countTimeIntegrateDepth = 0;

double TimingLog::totalTimeTransferTexture = 0.0;
unsigned int TimingLog::countTimeTransferTexture = 0;

double TimingLog::totalTimeOptimizeTexture = 0.0;
unsigned int TimingLog::countTimeOptimizeTexture = 0;

double TimingLog::totalTimeBlendingTexture = 0.0;
unsigned int TimingLog::countTimeBlendingTexture = 0;
/////////////
// benchmark
/////////////
